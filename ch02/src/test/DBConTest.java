...
public class DBConTest {
    public static void main(String[] args) {
        ...
        //final String URL = "jdbc:mariadb://localhost:3306/edu";  /* http://localhost:8081/test1.jsp */
        ...
        String sql = "select * from member where id=?"; /* "select * from member where id='admin'" */
        String id = "admin";
        try {
